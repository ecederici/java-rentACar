...
public class BusinessMessages {
    ...
    public static final String INVALID_TAX_NUMBER = "Tax number must be equal to 10.";
    ...
    public static final String INVALID_NATIONAL_IDENTITY_NUMBER = "National identity number must be equal to 11.";
    ...
    public static final String PAYMENT_FAILED = "Card number is invalid. Please check your card details.";
